    ...
    <div class="row mb-9">
      <div class="col-md">
        <div class="ftco-footer-widget mb-8">
          <h1 class="logo"><a href="#">Mapala <span>Wanatel</span></a></h1>
          <p>Salam Lestari</p>
          <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
            <li class="ftco-animate"><a href="https://www.facebook.com/Mapala-Wanatel-799487390174536/"><span class="icon-facebook"></span></a></li>
            <li class="ftco-animate"><a href="https://www.instagram.com/mapal_wanatel/"><span class="icon-instagram"></span></a></li>
          </ul>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <p>
          ...
          </script> All rights reserved | Mapala Wanatel <i class="icon-user color-danger" aria-hidden="true"></i><br>
        </p>
      </div>
    </div>
  </div>
